...
app.get(["/", "/generate"], async (req, res) => {
  try {
    ...
    const prompt_guidance_rescale = parseFloat(req.query.pgr) || 5;
...
return res.redirect(302, gitRawUrl);
    ...
    const aiParams = { width, height, steps, scale, sampler, negative_prompt, noise_schedule, prompt_guidance_rescale };
